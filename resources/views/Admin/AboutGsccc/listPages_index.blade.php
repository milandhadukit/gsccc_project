...
@section('content')
    <div class="card">
        ...
        align-items: center;">
            ...
            <a href="{{ route('about-add') }}" class="btn btn-outline-success"> Add New</a>&nbsp;&nbsp;
                    ...
                    <tbody>
                        @foreach ($data as $key => $item)
                            <tr>
                                ...
                                <td>{{ $item->title_hi }}</td>
                                <td>{{ $item->title_gu }}</td>
                                <td  >{!! html_entity_decode($item->content_en )  !!}</td>
                                <td>{!! html_entity_decode($item->content_hi ) !!}</td>
                                <td>{!! html_entity_decode($item->content_gu ) !!}</td>
